  ...
  return (
    <React.Fragment>
      ...
      <div className="flex justify-center items-center mt-20">
        <Link className="font-span bg-transparent text-white text-l font-bold text-center mr-4 px-14 py-2 border border-solid border-gray-300 rounded-lg hover:bg-primary hover:border-primary">Login</Link>
